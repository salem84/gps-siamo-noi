angular.module('gpsSiamoNoiApp', ['twitterServices', 'ui.bootstrap'])
	...
	$routeProvider.
		...
		when('/segnala', { templateUrl: 'partials/segnala.html', controller: NuovaSegnalazioneCtrl }).
		otherwise({ redirectTo: '/segnala' });
	}]);